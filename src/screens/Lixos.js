...
export default class Lixo extends Component {
    state = {
        acessoemps: [],
        usuario: [],
        visible: [],
...
//---------------------------------------------------------------------------------------
    AddLixos = async  locData  => {
        this.setState({loading: true})
        try {
            const res = await axios.post(`${server}/lixos`, {
                lixosDataCadastro: new Date(), 
...
//--------------------------------------------------------------------------------------- 
    updateLixos = async  lixo  => {
        try {
            await axios.put(`${server}/lixos/atualisa`, {
                lixos_id: dados.id,
                lixosSetor: lixo.lixosSetor,
                lixosIrregularida: lixo.lixosIrregularida,
                lixosPrevencao: lixo.lixosPrevencao,
                lixosObservacao: lixo.lixosObservacao,
                lixosDataUpdate: new Date()
            })
        ...
        if(this.state.loading){
            ...
            return (
                <View style={styles.container}>
                    <AddLixo {...this.state} isVisible={this.state.showAdd} 
                        onSave={this.updateLixos}
                    ...
                    <View style={styles.taksContainer}>
                        <Text style={styles.titletela}>Lixos</Text>
                        <View style={styles.linha} />
                    </View>
