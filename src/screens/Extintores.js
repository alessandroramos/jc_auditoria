...
import AddExtintore from './AddExtintore'
...
export default class Extintore extends Component {
    state = {
        acessoemps: [],
        usuario: [],
        visible: [],
...
//---------------------------------------------------------------------------------------
    AddExtintores = async  locData  => {
        this.setState({loading: true})
        try {
            const res = await axios.post(`${server}/extintores`, {
                extintoresDataCadastro: new Date(), 
...
//--------------------------------------------------------------------------------------- 
    updateExtintores = async  extintore  => {
        try {
            await axios.put(`${server}/extintores/atualisa`, {
                extintores_id: dados.id,
                extintoresLocal:      extintore.extintoresLocal,
                extintoresCarga:      extintore.extintoresCarga,
                extintoresLimpeza:    extintore.extintoresLimpeza,
                extintoresPressao:    extintore.extintoresPressao,
                extintoresValidade:   extintore.extintoresValidade,
                extintoresLacre:      extintore.extintoresLacre,
                extintoresPrevencao:  extintore.extintoresPrevencao,
                extintoresObservacao: extintore.extintoresObservacao,
                extintoresDataUpdate: new Date()
            })
        ...
        if(this.state.loading){
            ...
            return (
                <View style={styles.container}>
                    <AddExtintore {...this.state} isVisible={this.state.showAdd} 
                        onSave={this.updateExtintores}
                    ...
                    <View style={styles.taksContainer}>
                        <Text style={styles.titletela}>Extintores</Text>
                        <View style={styles.linha} />
                    </View>
