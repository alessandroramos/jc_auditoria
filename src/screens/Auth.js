...
//--------------------------------------------Aqui valida usuario
    signin = async () => {
        const empresas_id = this.state.empresas_id
...
//            console.log(res.data)
            ...
            this.props.navigation.navigate('Home', res.data)
             ...
             showError('Usuario Não Tem Acesso a Esta Empresa!')
        }
    }
    ...
    buscaEmpresa = async cnp => {
        try {
            ...
            if(ress.data.length > 0){
                this.setState({ empresas_id: ress.data[0].empresas_id})
    ...
    render() {
        ...
        return (
            <ImageBackground  
                ...
                <Text style={styles.title}>JC Auditoria</Text>
