...
import AddProcDoc from './AddProcDoc'
...
export default class ProcDoc extends Component {
    state = {
        acessoemps: [],
        usuario: [],
        visible: [],
...
//---------------------------------------------------------------------------------------
    AddProcDocs = async  locData  => {
        this.setState({loading: true})
        try {
            const res = await axios.post(`${server}/protocolos`, {
                protocolosDataCadastro: new Date(), 
...
//--------------------------------------------------------------------------------------- 
    updateProcDocs = async  protocolos  => {
        try {
            await axios.put(`${server}/protocolos/atualisa`, {
                protocolos_id: dados.id,
                protocolosLacre:        protocolos.protocolosLacre,
                protocolosDocEqui:      protocolos.protocolosDocEqui,
                protocolosMotorista:    protocolos.protocolosMotorista,
                protocolosDocMotorista: protocolos.protocolosDocMotorista,
                protocolosrecebimento:  protocolos.protocolosrecebimento,
                protocolosExpedicao:    protocolos.protocolosExpedicao,
                protocolosPrevencao:    protocolos.protocolosPrevencao,
                protocolosDataCancel: new Date()
            })
        ...
        if(this.state.loading){
            ...
            return (
                <View style={styles.container}>
                    <AddProcDoc {...this.state} isVisible={this.state.showAdd} 
                        onSave={this.updateProcDocs}
                    ...
                    <View style={styles.taksContainer}>
                        <Text style={styles.titletela}>ProcDocs</Text>
                        <View style={styles.linha} />
                    </View>
