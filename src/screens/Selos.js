...
//---------------------------------------------------------------------------------------
    AddSelos = async  locData  => {
        this.setState({loading: true})
        try {
            const res = await axios.post(`${server}/selos`, {
                selosDataCadastro: new Date(), 
...
//--------------------------------------------------------------------------------------- 
    updateSelos = async  selo  => {
        try {
            await axios.put(`${server}/selos/atualisa`, {
                selos_id: dados.id,
                selosSetor: selo.selosSetor,
                selosProduto: selo.selosProduto,
                selosQuantidade: selo.selosQuantidade,
                selosPrevencao: selo.selosPrevencao,
                selosObservacao: selo.selosObservacao,
                selosResponsavel: selo.selosResponsavel,
                selosDataUpdate: new Date()
            })
        ...
        if(this.state.loading){
            ...
            return (
                <View style={styles.container}>
                    <AddSelo {...this.state} isVisible={this.state.showAdd} 
                        onSave={this.updateSelos}
                    ...
                    <View style={styles.taksContainer}>
                        <Text style={styles.titletela}>Selos</Text>
                        <View style={styles.linha} />
                    </View>
