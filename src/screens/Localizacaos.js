...
import AddLocalizacao from './AddLocalizacao'
...
//---------------------------------------------------------------------------------------
    AddLocalizacaos = async  locData  => {
        this.setState({loading: true})
        try {
            const res = await axios.post(`${server}/localizacaos`, {
        ...
        const SisRotIdtabela = dados.sistemaId+dados.rotinaId+dados.usersId+dados.id
...
//--------------------------------------------------------------------------------------- 
    updateLocalizacaos = async  localizacao  => {
        try {
            await axios.put(`${server}/localizacaos/atualisa`, {
                localizacaos_id: dados.id,
                localizacaosSetor: localizacao.localizacaosSetor,
                localizacaosProduto: localizacao.localizacaosProduto,
                localizacaosQuantidade: localizacao.localizacaosQuantidade,
                localizacaosPrevencao: localizacao.localizacaosPrevencao,
                localizacaosObservacao: localizacao.localizacaosObservacao,
                localizacaosDataUpdate: new Date()
            })
        ...
        if(this.state.loading){
            ...
            return (
                <View style={styles.container}>
                    <AddLocalizacao {...this.state} isVisible={this.state.showAdd} 
                        onSave={this.updateLocalizacaos}
                    ...
                    <View style={styles.taksContainer}>
                        <Text style={styles.titletela}>Localizacaos</Text>
                        <View style={styles.linha} />
                    </View>
