...
import AddGeradore from './AddGeradore'
...
export default class Geradore extends Component {
    state = {
        acessoemps: [],
        usuario: [],
        visible: [],
...
//---------------------------------------------------------------------------------------
    AddGeradores = async  locData  => {
        this.setState({loading: true})
        try {
            const res = await axios.post(`${server}/geradores`, {
                geradoresDataCadastro: new Date(), 
...
//--------------------------------------------------------------------------------------- 
    updateGeradores = async  geradore  => {
        try {
            await axios.put(`${server}/geradores/atualisa`, {
                geradores_id: dados.id,
                geradoresAguaRadiador: geradore.geradoresAguaRadiador,
                geradoresOleoMotor:    geradore.geradoresOleoMotor,
                geradoresCombustivel:  geradore.geradoresCombustivel,
                geradoresCondicoes:    geradore.geradoresCondicoes,
                geradoresResponsavel:  geradore.geradoresResponsavel,
                geradoresPrevencao:    geradore.geradoresPrevencao,
                geradoresObservacao:   geradore.geradoresObservacao,
                geradoresDataUpdate: new Date()
            })
        ...
        if(this.state.loading){
            ...
            return (
                <View style={styles.container}>
                    <AddGeradore {...this.state} isVisible={this.state.showAdd} 
                        onSave={this.updateGeradores}
                    ...
                    <View style={styles.taksContainer}>
                        <Text style={styles.titletela}>Geradores</Text>
                        <View style={styles.linha} />
                    </View>
