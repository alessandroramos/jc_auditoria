...
import AddArmario from './AddArmario'
...
export default class Armario extends Component {
    state = {
        acessoemps: [],
        usuario: [],
        visible: [],
...
//---------------------------------------------------------------------------------------
    AddArmarios = async  locData  => {
        this.setState({loading: true})
        try {
            const res = await axios.post(`${server}/armarios`, {
                armariosDataCadastro: new Date(),
...
//--------------------------------------------------------------------------------------- 
    updateArmarios = async  armario  => {
        try {
            await axios.put(`${server}/armarios/atualisa`, {
                armarios_id: dados.id,
                armariosIdentificador: armario.armariosIdentificador,
                armariosColaborador: armario.armariosColaborador,
                armariosDocColaborador: armario.armariosDocColaborador,
                armariosPrevencao: armario.armariosPrevencao,
                armariosDataUpdate: new Date()
            })
        ...
        if(this.state.loading){
            ...
            return (
                <View style={styles.container}>
                    <AddArmario {...this.state} isVisible={this.state.showAdd} 
                        onSave={this.updateArmarios}
                    ...
                    <View style={styles.taksContainer}>
                        <Text style={styles.titletela}>Armarios</Text>
                        <View style={styles.linha} />
                    </View>
