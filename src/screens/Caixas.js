...
//---------------------------------------------------------------------------------------
    AddCaixas = async  locData  => {
        this.setState({loading: true})
        try {
            const res = await axios.post(`${server}/caixas`, {
                caixasDataCadastro: new Date(), 
...
//--------------------------------------------------------------------------------------- 
    updateCaixas = async  caixa  => {
        const diferenca = caixa.caixasValor - caixa.caixasFisico
        try {
            await axios.put(`${server}/caixas/atualisa`, {
                caixas_id: dados.id,
                caixasOperador:       caixa.caixasOperador,
                caixasValor:          caixa.caixasValor,
                caixasFisico:         caixa.caixasFisico,
                caixasDifereca:       diferenca,
                caixasDocOperador:    caixa.caixasDocOperador,
                caixasDocResponsavel: caixa.caixasDocResponsavel,
                caixasDocPrevecao:    caixa.caixasDocPrevecao,
                caixasObservacao:     caixa.caixasObservacao,
                caixasDataUpdate: new Date()
            })
        ...
        if(this.state.loading){
            ...
            return (
                <View style={styles.container}>
                    <AddCaixa {...this.state} isVisible={this.state.showAdd} 
                        onSave={this.updateCaixas}
                    ...
                    <View style={styles.taksContainer}>
                        <Text style={styles.titletela}>Caixas</Text>
                        <View style={styles.linha} />
                    </View>
